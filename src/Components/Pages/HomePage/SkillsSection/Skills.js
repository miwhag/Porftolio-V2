    ...
    return (
        ...
        <div className="Skills-main-container">
            <div className="Skills-about-me-greeting">
                ...
                <p className="Skills-about-me-paragraph"> Driven by curiousity, new adventures and challenges, I previously worked in the pastry industry as a cake decorator, food stylist, tutorial writer and production assistant. <br></br><br></br>
